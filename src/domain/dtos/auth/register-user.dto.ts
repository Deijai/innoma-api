...
export class RegisterUserDto {
  ...
  static create(object: { [key: string]: any }): [string?, RegisterUserDto?] {
    ...
    if (isDoctor) {
      ...
      // Validar se todas as especialidades são strings válidas (ObjectId format)
    ...
    // Validar CPF (opcional, apenas para PATIENT)
    if (cpf && roles.includes(USER_ROLES.PATIENT)) {
